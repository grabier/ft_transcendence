...
const NotificationCard = styled(Box)<{ $bgColor: string }>(({ theme, $bgColor }) => ({
    minWidth: "300px",
    backgroundColor: "#FFFFFF",
    border: `3px solid ${theme.palette.text.primary}`,
    boxShadow: `8px 8px 0px 0px ${$bgColor}`, // Sombra dinámica
    display: "flex",
...
const NotificationHeader = styled(Box)<{ $bgColor: string }>(({ theme, $bgColor }) => ({
    backgroundColor: $bgColor, // Fondo dinámico
    color: "#FFFFFF",
    padding: "4px 12px",
    display: "flex",
    alignItems: "center",
